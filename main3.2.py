...
# МОЖНО ЛИ ДЛЯ РАЗМЕРА РЮКЗАКА 7
...
def get_memtable(stuffdict, A=6):
...
def get_selected_items_list(stuffdict, A=6):
...
selected_stuff = get_selected_items_list(stuffdict, A=6)
